<script>
	...
	import TopicMessages from './TopicMessages.svelte'
...
<FloatWindow title={current_thing.title.substr(0,g_max_title_chars) + '...'} scale_size={window_scale} use_smoke={false}>
	...
	<TopicMessages {...current_thing}  items={items} graphs={component_graphs} cols={cols} rowHeight={50} />
</FloatWindow>
